...
export async function checkEntityBindings(
    ...
    return {
        permissions: getMinimumReadOnlySharedEntryPermissions([
    ...
    const [collectionEntryPermissions, datasetEntryPermissions, workbookEntryPermissions] =
        await Promise.all([
            ...
            datasetToWorkbookBinding.isDelegated || isDatasetInsideWorkbook
                ? Promise.resolve(getReadOnlySharedEntryPermissions())
...
async function checkCollectionEntry(
    ...
    return {
        ...
        permissions: mapReadOnlySharedEntryPermissions({
            permissions: sharedEntryInstance.permissions,
            ctx,
        }),
    };
}
...
async function getSourcePermissions(
    ...
    if (isDelegated) {
        ...
        return {
            permissions: getReadOnlySharedEntryPermissions(),
            fullPermissions,
        };
    }
