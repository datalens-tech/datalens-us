...
export async function up(knex: Knex): Promise<void> {
    return knex.raw(`
        CREATE TABLE data_exports (
            ...
            connection_id BIGINT NOT NULL REFERENCES entries (entry_id) ON UPDATE CASCADE ON DELETE SET NULL,
            connection_rev_id BIGINT NOT NULL REFERENCES revisions (rev_id) ON UPDATE CASCADE ON DELETE SET NULL,
