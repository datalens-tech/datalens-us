...
export async function up(knex: Knex): Promise<void> {
    return knex.raw(`
        ...
        CREATE FUNCTION get_active_creators_limit(
            p_tenant_id TEXT,
            ...
            FOR v_violation IN
                ...
                violations AS (
                    SELECT 
                        ...
                        ct.check_time,
                        get_active_creators_limit(v_tenant_id, ct.check_time) as limit_value,
                        COUNT(l.license_id) as active_count
                    FROM check_times ct
        ...
        CREATE CONSTRAINT TRIGGER enforce_license_limits_on_limits
...
export async function down(knex: Knex): Promise<void> {
    return knex.raw(`
        DROP TRIGGER enforce_license_limits_on_limits ON license_limits;
        DROP TRIGGER enforce_license_limits_on_licenses ON licenses;

        DROP FUNCTION enforce_license_limits();
        DROP FUNCTION get_active_creators_limit(TEXT, TIMESTAMPTZ);
